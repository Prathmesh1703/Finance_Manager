...
import { FaSync } from "react-icons/fa"; // Added sync icon
      ...
      {loading ? (
        ...
        >
            ...
            <div className="text-white type">
              <Form.Group className="mb-3" controlId="formSelectFrequency">
                ...
                >
                  ...
                  <option value="credit">Income</option> {/* Updated label */}
                </Form.Select>
              </Form.Group>
            </div>
              ...
              <Modal show={show} onHide={handleClose} centered>
                ...
                <Modal.Body>
                  <Form>
                    ...
                    <Form.Group className="mb-3" controlId="formDate">
                      <Form.Label>
                        Date <span className="text-danger">*</span> {/* Added required indicator */}
                      </Form.Label>
                      <Form.Control
                        type="date"
                        name="date"
                ...
                <Modal.Footer>
                  ...
                  <Button variant="primary" onClick={handleSubmit}>
                    Add Transaction {/* Updated button text */}
                  </Button>
                </Modal.Footer>
              </Modal>
            </div>
            ...
            <div className="date">
              <div className="form-group">
                ...
                <DatePicker
                  ...
                  startDate={startDate}
                  endDate={endDate}
                  placeholderText="Select start date" // Added placeholder
                />
              </div>
              <div className="form-group">
                ...
                <DatePicker
                  ...
                  endDate={endDate}
                  minDate={startDate}
                  placeholderText="Select end date" // Added placeholder
                />
              </div>
            </div>
          )}
          ...
          <div className="containerBtn">
            ...
            >
              <FaSync /> Reset Filter {/* Added icon */}
            </Button>
          </div>
